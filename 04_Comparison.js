...
// Comparison using ===
console.log("Comparison using ===(Strict Equality Check");
...
console.log('02' < 1);         // false, '02' is converted to number 2
console.log('5' <= 5);         // true, '5' is converted to number 5
...
console.log(null <= 0);        // true, null is converted to 0, 0 <= 0 is true
console.log(null == 0);        // false, null is not converted to 0 and null is not loosely equal to 0
console.log(null == undefined); // true, null is loosely equal to undefined
